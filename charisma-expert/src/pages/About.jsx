      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-5 text-gray-600 leading-relaxed bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
            ...
            <p>General-purpose AI tools created another concern: sensitive law-enforcement information should not be entered into platforms an agency has not approved for handling that information. Existing report-writing systems could also be complicated, expensive, or too broad for everyday law-enforcement documentation.</p>
            ...
            <p>KLYVOREK helps law-enforcement personnel turn officer-provided facts into clear incident reports, organized investigative documentation, and structured arrest and search warrant application drafts while keeping the professional in control.</p>
